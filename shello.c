 ...
 * @ac: argument num
 * @av: argument value
 * description: program does these
 * 1. prompts user to enter a line
 * 2. command is passed into the program through main ()
 * 3. tokenizes command into smaller strings
 ...
 * 5. forks program to create a new process
 * 6. uses execve function to execute the command in the child process
 * 7. parent process waits for another command to be input
 * Return: 0
 */
